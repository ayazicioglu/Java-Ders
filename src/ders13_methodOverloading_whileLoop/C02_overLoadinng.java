...
public class C02_overLoadinng {
    public static void main(String[] args) {
        ...
        //ve ayni isimdeki method'lardan hangisinin calisacagina arguement/parametre uyumu karar verir
        toplama(5,6);
        toplama(5,3,1);
        toplama(6,6);
        toplama(4.5,5);
    ...
    public static void toplama(int sayi1, int sayi2,int sayi3){
        System.out.println("3 tam sayinin toplami: "+(sayi1+sayi2));
    }
