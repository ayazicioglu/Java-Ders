...
public class C06_ArraydekiTekrarlardanKurtulma {
    public static void main(String[] args) {
        //verilen bir array'deki tekrar eden elementleri sadece 1 kere yazarak array'i kısaltan kod yazının
        //
        ...
        //Set'deki element sayisina esit bir array olusturup Set'deki elementleri oraya tasiyalım

        arr=new int[arrSet.size()];//[0, 0, 0, 0, 0, 0] haline geldi
        int index=0;
        for (int each:arrSet
             ) {
            arr[index]=each;
