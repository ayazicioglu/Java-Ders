...
public class C12_fibonacciSorusu {
    public static void main(String[] args) {
        ...
        //fibonacciListesiOlustur(); ya atayacağız böyle yada yazdıracağız. biz yazdıralım
    ...
    public static List<Integer> fibonacciListesiOlustur(){
        ...
        System.out.println("Lütfen kaç tane fibonacci istediğinizi giriniz: ");
        int n=scan.nextInt();
